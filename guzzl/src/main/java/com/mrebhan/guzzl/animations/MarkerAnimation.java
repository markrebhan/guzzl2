...
public class MarkerAnimation {
	...
	public static void animateMarkerHC(final Marker marker, final GoogleMap googleMap, final double bearing, final double velocity){
		...
		valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				...
				LatLng newposition = LatLngInterpolator.interpolate(fraction, startPosition, bearing, velocity);
